...
```
Nov 04 14:24:59 vpp-m7-9 systemd-udevd[43843]: ens2f0: MAC on the device already set by userspace
```
...
```
Nov 04 14:26:51 vpp-m7-9 systemd-udevd[44477]: ens2f0: Using generated persistent MAC address
```
