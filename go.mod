...
require (
	...
	github.com/projectcalico/api v0.0.0-202205231559-852f5034c309 // v3.23.0
	github.com/projectcalico/calico v0.0.0-202205004419-2fd5e11958cd // v3.23.0
...
replace (
	github.com/projectcalico/api => github.com/projectcalico/api v0.0.0-202205231559-852f5034c309 // v3.23.0
