...
import (
	...
	networkv3 "github.com/projectcalico/vpp-dataplane/v3/pkg/calico-vpp-agent/network"
	nadv1 "github.com/projectcalico/vpp-dataplane/v3/pkg/multinet-monitor/multinettypes"
