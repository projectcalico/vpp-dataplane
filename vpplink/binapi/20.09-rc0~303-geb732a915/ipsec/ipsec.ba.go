...
// source: /Users/aloaugus/src/calico-vpp-dataplane/vpp-manager/vpp_build/build-root/install-vpp-native/vpp/share/vpp/api//core/ipsec.api.json
...
// IpsecItf represents VPP binary API type 'ipsec_itf'.
...
func (*IpsecItf) GetTypeName() string { return "ipsec_itf" }
...
// IpsecItfCreate represents VPP binary API message 'ipsec_itf_create'.
...
func (*IpsecItfCreate) GetMessageType() api.MessageType { return api.RequestMessage }

// IpsecItfCreateReply represents VPP binary API message 'ipsec_itf_create_reply'.
...
func (*IpsecItfCreateReply) GetMessageType() api.MessageType { return api.ReplyMessage }

// IpsecItfDelete represents VPP binary API message 'ipsec_itf_delete'.
...
func (*IpsecItfDelete) GetMessageType() api.MessageType { return api.RequestMessage }

// IpsecItfDeleteReply represents VPP binary API message 'ipsec_itf_delete_reply'.
...
func (*IpsecItfDeleteReply) GetMessageType() api.MessageType { return api.ReplyMessage }

// IpsecItfDetails represents VPP binary API message 'ipsec_itf_details'.
...
func (*IpsecItfDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// IpsecItfDump represents VPP binary API message 'ipsec_itf_dump'.
...
func (*IpsecItfDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
func init() {
	...
	api.RegisterMessage((*IpsecItfCreate)(nil), "ipsec.IpsecItfCreate")
	api.RegisterMessage((*IpsecItfCreateReply)(nil), "ipsec.IpsecItfCreateReply")
	api.RegisterMessage((*IpsecItfDelete)(nil), "ipsec.IpsecItfDelete")
	api.RegisterMessage((*IpsecItfDeleteReply)(nil), "ipsec.IpsecItfDeleteReply")
	api.RegisterMessage((*IpsecItfDetails)(nil), "ipsec.IpsecItfDetails")
	api.RegisterMessage((*IpsecItfDump)(nil), "ipsec.IpsecItfDump")
...
type RPCService interface {
	...
	DumpIpsecItf(ctx context.Context, in *IpsecItfDump) (RPCService_DumpIpsecItfClient, error)
...
func (c *serviceClient) DumpIpsecItf(ctx context.Context, in *IpsecItfDump) (RPCService_DumpIpsecItfClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpIpsecItfClient{stream}
	return x, nil
}

type RPCService_DumpIpsecItfClient interface {
	Recv() (*IpsecItfDetails, error)
}

type serviceClient_DumpIpsecItfClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpIpsecItfClient) Recv() (*IpsecItfDetails, error) {
	m := new(IpsecItfDetails)
	stop, err := c.MultiRequestCtx.ReceiveReply(m)
	if err != nil {
		return nil, err
	}
