...
// CalicoEnableDisableInterfaceSnat represents VPP binary API message 'calico_enable_disable_interface_snat'.
...
func (*CalicoEnableDisableInterfaceSnat) GetMessageType() api.MessageType { return api.RequestMessage }

// CalicoEnableDisableInterfaceSnatReply represents VPP binary API message 'calico_enable_disable_interface_snat_reply'.
...
func init() {
	api.RegisterMessage((*CalicoEnableDisableInterfaceSnat)(nil), "calico.CalicoEnableDisableInterfaceSnat")
	api.RegisterMessage((*CalicoEnableDisableInterfaceSnatReply)(nil), "calico.CalicoEnableDisableInterfaceSnatReply")
}
