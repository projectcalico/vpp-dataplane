...
// Ikev2ChildSa represents VPP binary API type 'ikev2_child_sa'.
type Ikev2ChildSa struct {
	...
	RSpi         uint32
	Keys         Ikev2Keys
	Encryption   Ikev2SaTransform
	Integrity    Ikev2SaTransform
	Esn          Ikev2SaTransform
}

func (*Ikev2ChildSa) GetTypeName() string { return "ikev2_child_sa" }

// Ikev2EspTransforms represents VPP binary API type 'ikev2_esp_transforms'.
...
func (*Ikev2EspTransforms) GetTypeName() string { return "ikev2_esp_transforms" }
...
// Ikev2IkeTransforms represents VPP binary API type 'ikev2_ike_transforms'.
...
func (*Ikev2IkeTransforms) GetTypeName() string { return "ikev2_ike_transforms" }

// Ikev2Keys represents VPP binary API type 'ikev2_keys'.
type Ikev2Keys struct {
	SkD     []byte `struc:"[64]byte"`
	SkDLen  uint8
	SkAi    []byte `struc:"[64]byte"`
	SkAiLen uint8
	SkAr    []byte `struc:"[64]byte"`
	SkArLen uint8
	SkEi    []byte `struc:"[64]byte"`
	SkEiLen uint8
	SkEr    []byte `struc:"[64]byte"`
	SkErLen uint8
	SkPi    []byte `struc:"[64]byte"`
	SkPiLen uint8
	SkPr    []byte `struc:"[64]byte"`
	SkPrLen uint8
}

func (*Ikev2Keys) GetTypeName() string { return "ikev2_keys" }
...
type Ikev2Profile struct {
	...
	IkeTs            Ikev2IkeTransforms
	EspTs            Ikev2EspTransforms
	Lifetime         uint64
...
// Ikev2Sa represents VPP binary API type 'ikev2_sa'.
type Ikev2Sa struct {
	SaIndex      uint32
	ProfileIndex uint32
	Ispi         uint64
	...
	Encryption   Ikev2SaTransform
	Integrity    Ikev2SaTransform
	Prf          Ikev2SaTransform
	Dh           Ikev2SaTransform
}

func (*Ikev2Sa) GetTypeName() string { return "ikev2_sa" }

// Ikev2SaTransform represents VPP binary API type 'ikev2_sa_transform'.
...
func (*Ikev2SaTransform) GetTypeName() string { return "ikev2_sa_transform" }
...
// Ikev2ChildSaDetails represents VPP binary API message 'ikev2_child_sa_details'.
...
func (*Ikev2ChildSaDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// Ikev2ChildSaDump represents VPP binary API message 'ikev2_child_sa_dump'.
...
func (*Ikev2ChildSaDump) GetMessageType() api.MessageType { return api.RequestMessage }
...
// Ikev2NonceGet represents VPP binary API message 'ikev2_nonce_get'.
...
func (*Ikev2NonceGet) GetMessageType() api.MessageType { return api.RequestMessage }

// Ikev2NonceGetReply represents VPP binary API message 'ikev2_nonce_get_reply'.
type Ikev2NonceGetReply struct {
	Retval  int32
	DataLen uint32 `struc:"sizeof=Nonce"`
	Nonce   []byte
}
...
func (*Ikev2NonceGetReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
// Ikev2SaDetails represents VPP binary API message 'ikev2_sa_details'.
...
func (*Ikev2SaDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// Ikev2SaDump represents VPP binary API message 'ikev2_sa_dump'.
...
// Ikev2TrafficSelectorDetails represents VPP binary API message 'ikev2_traffic_selector_details'.
...
func (*Ikev2TrafficSelectorDetails) GetMessageType() api.MessageType { return api.ReplyMessage }

// Ikev2TrafficSelectorDump represents VPP binary API message 'ikev2_traffic_selector_dump'.
...
func (*Ikev2TrafficSelectorDump) GetMessageType() api.MessageType { return api.RequestMessage }

func init() {
	api.RegisterMessage((*Ikev2ChildSaDetails)(nil), "ikev2.Ikev2ChildSaDetails")
	api.RegisterMessage((*Ikev2ChildSaDump)(nil), "ikev2.Ikev2ChildSaDump")
	...
	api.RegisterMessage((*Ikev2NonceGet)(nil), "ikev2.Ikev2NonceGet")
	api.RegisterMessage((*Ikev2NonceGetReply)(nil), "ikev2.Ikev2NonceGetReply")
	...
	api.RegisterMessage((*Ikev2SaDetails)(nil), "ikev2.Ikev2SaDetails")
	api.RegisterMessage((*Ikev2SaDump)(nil), "ikev2.Ikev2SaDump")
	...
	api.RegisterMessage((*Ikev2TrafficSelectorDetails)(nil), "ikev2.Ikev2TrafficSelectorDetails")
	api.RegisterMessage((*Ikev2TrafficSelectorDump)(nil), "ikev2.Ikev2TrafficSelectorDump")
}
...
type RPCService interface {
	DumpIkev2ChildSa(ctx context.Context, in *Ikev2ChildSaDump) (RPCService_DumpIkev2ChildSaClient, error)
	DumpIkev2Profile(ctx context.Context, in *Ikev2ProfileDump) (RPCService_DumpIkev2ProfileClient, error)
	DumpIkev2Sa(ctx context.Context, in *Ikev2SaDump) (RPCService_DumpIkev2SaClient, error)
	DumpIkev2TrafficSelector(ctx context.Context, in *Ikev2TrafficSelectorDump) (RPCService_DumpIkev2TrafficSelectorClient, error)
...
func (c *serviceClient) DumpIkev2ChildSa(ctx context.Context, in *Ikev2ChildSaDump) (RPCService_DumpIkev2ChildSaClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpIkev2ChildSaClient{stream}
	return x, nil
}

type RPCService_DumpIkev2ChildSaClient interface {
	Recv() (*Ikev2ChildSaDetails, error)
}

type serviceClient_DumpIkev2ChildSaClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpIkev2ChildSaClient) Recv() (*Ikev2ChildSaDetails, error) {
	m := new(Ikev2ChildSaDetails)
...
func (c *serviceClient) DumpIkev2Sa(ctx context.Context, in *Ikev2SaDump) (RPCService_DumpIkev2SaClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpIkev2SaClient{stream}
	return x, nil
}

type RPCService_DumpIkev2SaClient interface {
	Recv() (*Ikev2SaDetails, error)
}

type serviceClient_DumpIkev2SaClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpIkev2SaClient) Recv() (*Ikev2SaDetails, error) {
	m := new(Ikev2SaDetails)
	stop, err := c.MultiRequestCtx.ReceiveReply(m)
	if err != nil {
		return nil, err
	}
...
func (c *serviceClient) DumpIkev2TrafficSelector(ctx context.Context, in *Ikev2TrafficSelectorDump) (RPCService_DumpIkev2TrafficSelectorClient, error) {
	stream := c.ch.SendMultiRequest(in)
	x := &serviceClient_DumpIkev2TrafficSelectorClient{stream}
	return x, nil
}

type RPCService_DumpIkev2TrafficSelectorClient interface {
	Recv() (*Ikev2TrafficSelectorDetails, error)
}

type serviceClient_DumpIkev2TrafficSelectorClient struct {
	api.MultiRequestCtx
}

func (c *serviceClient_DumpIkev2TrafficSelectorClient) Recv() (*Ikev2TrafficSelectorDetails, error) {
	m := new(Ikev2TrafficSelectorDetails)
	stop, err := c.MultiRequestCtx.ReceiveReply(m)
	if err != nil {
		return nil, err
	}
