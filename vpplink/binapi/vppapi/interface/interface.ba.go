...
// SwInterfaceTxPlacementDump defines message 'sw_interface_tx_placement_dump'.
type SwInterfaceTxPlacementDump struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
}

func (m *SwInterfaceTxPlacementDump) Reset()               { *m = SwInterfaceTxPlacementDump{} }
func (*SwInterfaceTxPlacementDump) GetMessageName() string { return "sw_interface_tx_placement_dump" }
func (*SwInterfaceTxPlacementDump) GetCrcString() string   { return "f9e6675e" }
func (*SwInterfaceTxPlacementDump) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *SwInterfaceTxPlacementDump) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *SwInterfaceTxPlacementDump) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *SwInterfaceTxPlacementDump) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
}
...
func file_interfaces_binapi_init() {
	...
	api.RegisterMessage((*SwInterfaceTxPlacementDump)(nil), "sw_interface_tx_placement_dump_f9e6675e")
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*SwInterfaceTxPlacementDump)(nil),
