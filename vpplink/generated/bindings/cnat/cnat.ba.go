...
//   - table_id_ip4 -
//
// DuplicateCnatSnatDefaultPolicyToVrf defines message 'duplicate_cnat_snat_default_policy_to_vrf'.
type DuplicateCnatSnatDefaultPolicyToVrf struct {
	SwIfIndex interface_types.InterfaceIndex `binapi:"interface_index,name=sw_if_index" json:"sw_if_index,omitempty"`
}

func (m *DuplicateCnatSnatDefaultPolicyToVrf) Reset() { *m = DuplicateCnatSnatDefaultPolicyToVrf{} }
func (*DuplicateCnatSnatDefaultPolicyToVrf) GetMessageName() string {
	return "duplicate_cnat_snat_default_policy_to_vrf"
}
func (*DuplicateCnatSnatDefaultPolicyToVrf) GetCrcString() string { return "f9e6675e" }
func (*DuplicateCnatSnatDefaultPolicyToVrf) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *DuplicateCnatSnatDefaultPolicyToVrf) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.SwIfIndex
...
func (m *DuplicateCnatSnatDefaultPolicyToVrf) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *DuplicateCnatSnatDefaultPolicyToVrf) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.SwIfIndex = interface_types.InterfaceIndex(buf.DecodeUint32())
	return nil
}

// DuplicateCnatSnatDefaultPolicyToVrfReply defines message 'duplicate_cnat_snat_default_policy_to_vrf_reply'.
type DuplicateCnatSnatDefaultPolicyToVrfReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *DuplicateCnatSnatDefaultPolicyToVrfReply) Reset() {
	*m = DuplicateCnatSnatDefaultPolicyToVrfReply{}
}
func (*DuplicateCnatSnatDefaultPolicyToVrfReply) GetMessageName() string {
	return "duplicate_cnat_snat_default_policy_to_vrf_reply"
}
func (*DuplicateCnatSnatDefaultPolicyToVrfReply) GetCrcString() string { return "e8d4e804" }
func (*DuplicateCnatSnatDefaultPolicyToVrfReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *DuplicateCnatSnatDefaultPolicyToVrfReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *DuplicateCnatSnatDefaultPolicyToVrfReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *DuplicateCnatSnatDefaultPolicyToVrfReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
	m.Retval = buf.DecodeInt32()
	return nil
}
...
type FeatureCnatEnableDisable struct {
	...
	TableIDIP4    uint32                         `binapi:"u32,name=table_id_ip4" json:"table_id_ip4,omitempty"`
	TableIDIP6    uint32                         `binapi:"u32,name=table_id_ip6" json:"table_id_ip6,omitempty"`
}
...
func (*FeatureCnatEnableDisable) GetCrcString() string   { return "572d40f6" }
...
func (m *FeatureCnatEnableDisable) Marshal(b []byte) ([]byte, error) {
	...
	buf.EncodeUint32(m.TableIDIP4)
	buf.EncodeUint32(m.TableIDIP6)
	return buf.Bytes(), nil
}
func (m *FeatureCnatEnableDisable) Unmarshal(b []byte) error {
	...
	m.TableIDIP4 = buf.DecodeUint32()
	m.TableIDIP6 = buf.DecodeUint32()
	return nil
}
...
func file_cnat_binapi_init() {
	...
	api.RegisterMessage((*DuplicateCnatSnatDefaultPolicyToVrf)(nil), "duplicate_cnat_snat_default_policy_to_vrf_f9e6675e")
	api.RegisterMessage((*DuplicateCnatSnatDefaultPolicyToVrfReply)(nil), "duplicate_cnat_snat_default_policy_to_vrf_reply_e8d4e804")
	api.RegisterMessage((*FeatureCnatEnableDisable)(nil), "feature_cnat_enable_disable_572d40f6")
...
func AllMessages() []api.Message {
	return []api.Message{
		...
		(*DuplicateCnatSnatDefaultPolicyToVrf)(nil),
		(*DuplicateCnatSnatDefaultPolicyToVrfReply)(nil),
