...
import (
	...
	ipsec_types "github.com/projectcalico/vpp-dataplane/vpplink/generated/bindings/ipsec_types"
	tunnel_types "github.com/projectcalico/vpp-dataplane/vpplink/generated/bindings/tunnel_types"
...
func (*IpsecSpdEntryAddDelV2) GetMessageType() api.MessageType { return api.RequestMessageType }
...
func (*IpsecSpdEntryAddDelV2Reply) GetMessageType() api.MessageType { return api.ReplyMessageType }
func (m *IpsecSpdEntryAddDelV2Reply) GetRetVal() error {
	return api.RetvalToVPPApiError(int32(m.Retval))
}
