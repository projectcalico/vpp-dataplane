...
func (*Nat44UserSessionV3Details) GetMessageType() api.MessageType { return api.ReplyMessageType }
func (m *Nat44UserSessionV3Details) GetRetVal() error {
	return nil
}
...
func (*Nat44UserSessionV3Dump) GetMessageType() api.MessageType { return api.RequestMessageType }
