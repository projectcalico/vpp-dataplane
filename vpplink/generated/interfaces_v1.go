...
func (v *Vpp) DeleteLoopback(iface *types.Interface) (err error) {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) CreateTapV2(tap *types.TapInterface) (swIfIndex uint32, err error) {
	...
	request := &tapv2.TapCreateV3{
		...
		TxRingSz:    uint16(defaultIntTo(tap.TxQueueSize, types.DefaultQueueSize)),
		RxRingSz:    uint16(defaultIntTo(tap.RxQueueSize, types.DefaultQueueSize)),
...
func (v *Vpp) CreateOrAttachTapV2(tap *types.TapInterface) (swIfIndex uint32, err error) {
...
func (v *Vpp) DelTap(iface *types.Interface) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) getInterfaceAddresses(iface *types.Interface, isv6 bool) (addresses []types.IfAddress, err error) {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) SetInterfaceMtu(iface *types.Interface, mtu int) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) SetInterfaceRxMode(iface *types.Interface, queueID uint32, mode types.RxMode) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) SetInterfaceMacAddress(iface *types.Interface, mac *net.HardwareAddr) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) SetInterfaceVRF(iface *types.Interface, vrfIndex uint32, isIP6 bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) addDelInterfaceAddress(iface *types.Interface, addr *net.IPNet, isAdd bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) setUnsetInterfaceTag(iface *types.Interface, tag string, isAdd bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) enableDisableGso(iface *types.Interface, enable bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) setInterfacePromiscuous(iface *types.Interface, promiscOn bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) SetInterfaceTxPlacement(iface *types.Interface, queue int, worker int) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) SetInterfaceRxPlacement(iface *types.Interface, queue int, worker int, main bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) interfaceAdminUpDown(iface *types.Interface, up bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) enableDisableInterfaceIP(iface *types.Interface, isIP6 bool, isEnable bool) error {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) GetInterfaceDetails(iface *types.Interface) (i *types.InterfaceDetails, err error) {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) GetInterfaceNeighbors(iface *types.Interface, isIPv6 bool) (err error, neighbors []types.Neighbor) {
	v.Lock()
	defer v.Unlock()
...
func (v *Vpp) EnableInterfaceIP46(iface *types.Interface) (err error) {
...
func (v *Vpp) DisableInterfaceIP46(iface *types.Interface) (err error) {
...
func (v *Vpp) DisableInterfaceIP4(iface *types.Interface) error {
	return v.enableDisableInterfaceIP(iface, false /*isIP6*/, false /*isEnable*/)
}

func (v *Vpp) EnableInterfaceIP4(iface *types.Interface) error {
	return v.enableDisableInterfaceIP(iface, false /*isIP6*/, true /*isEnable*/)
}

func (v *Vpp) DisableInterfaceIP6(iface *types.Interface) error {
	return v.enableDisableInterfaceIP(iface, true /*isIP6*/, false /*isEnable*/)
}

func (v *Vpp) EnableInterfaceIP6(iface *types.Interface) error {
	return v.enableDisableInterfaceIP(iface, true /*isIP6*/, true /*isEnable*/)
}

func (v *Vpp) GetInterfaceAddressesIP4(iface *types.Interface) ([]types.IfAddress, error) {
	return v.getInterfaceAddresses(iface, false /*isIP6*/)
}

func (v *Vpp) GetInterfaceAddressesIP6(iface *types.Interface) ([]types.IfAddress, error) {
	return v.getInterfaceAddresses(iface, true /*isIP6*/)
}
func (v *Vpp) SetInterfaceVrfIP4(iface *types.Interface, vrfIndex uint32) error {
	return v.SetInterfaceVRF(iface, vrfIndex, false /*isIP6*/)
}

func (v *Vpp) SetInterfaceVrfIP6(iface *types.Interface, vrfIndex uint32) error {
	return v.SetInterfaceVRF(iface, vrfIndex, true /*isIP6*/)
}

func (v *Vpp) AddInterfaceAddress(iface *types.Interface, addr *net.IPNet) error {
	return v.addDelInterfaceAddress(iface, addr, true)
}

func (v *Vpp) DelInterfaceAddress(iface *types.Interface, addr *net.IPNet) error {
	return v.addDelInterfaceAddress(iface, addr, false)
}

func (v *Vpp) SetInterfaceTag(iface *types.Interface, tag string) error {
	return v.setUnsetInterfaceTag(iface, tag, true /* isAdd */)
}

func (v *Vpp) UnsetInterfaceTag(iface *types.Interface, tag string) error {
	return v.setUnsetInterfaceTag(iface, tag, false /* isAdd */)
}

func (v *Vpp) EnableGSOFeature(iface *types.Interface) error {
	return v.enableDisableGso(iface, true)
}

func (v *Vpp) DisableGSOFeature(iface *types.Interface) error {
	return v.enableDisableGso(iface, false)
}

func (v *Vpp) SetPromiscOn(iface *types.Interface) error {
	return v.setInterfacePromiscuous(iface, true)
}

func (v *Vpp) SetPromiscOff(iface *types.Interface) error {
	return v.setInterfacePromiscuous(iface, false)
}

func (v *Vpp) InterfaceAdminDown(iface *types.Interface) error {
	return v.interfaceAdminUpDown(iface, false)
}

func (v *Vpp) InterfaceAdminUp(iface *types.Interface) error {
